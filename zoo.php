...
$cat3 = new Cat(3);
$cat3Chip = new Chip("MA-1234", "Mani", new DateTime("2009-12-06 12:13:00"));
$cat3Chip->setSpecies($cat3::getSpecies());
$chippedCat3 = new ChippedAnimal($cat3, $cat3Chip);
...
$zooService->addChippedAnimal($chippedCat3);
